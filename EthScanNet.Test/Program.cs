...
namespace EthScanNet.Test
{
    class Program
    {
        ...
        private static async Task RunAccountCommandsAsync(EthScanClient client)
        {
            ...
            EthApiBalance apiBalance = await client.Accounts.GetBalanceAsync(new("0x44ed8e0c45b82d12caf02f73294fa9afed48ed80"));
            EthApiTransactions normalApiTransaction = await client.Accounts.GetNormalTransactionsAsync(new("0x44ed8e0c45b82d12caf02f73294fa9afed48ed80"));
            EthApiTransactions internalApiTransaction = await client.Accounts.GetInternalTransactionsAsync(new("0x44ed8e0c45b82d12caf02f73294fa9afed48ed80"));
            ...
            EthApiTokenTransferEvents apiTokenTransferEvents = await client.Accounts.GetTokenEvents(new("0x44ed8e0c45b82d12caf02f73294fa9afed48ed80"));
