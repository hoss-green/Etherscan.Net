...
{
    internal class EScanGetInternalTransactions : EScanAccountRequest, IPaginationResponse
    {
        public int? Page { get; set; }
        public int? Offset { get; set; }
        public ulong? StartBlock { get; private set; }
        public ulong? EndBlock { get; private set; }
        public EScanGetInternalTransactions(EScanAddress address, ulong? startBlock, ulong? endBlock, int? page, int? offset, EScanClient eScanClient)
